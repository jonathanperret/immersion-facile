...
import { ListAgenciesByFilter } from "./ListAgenciesByFilter";
...
describe("ListAgencies", () => {
  ...
  let listAgenciesByFilter: ListAgenciesByFilter;

  beforeEach(() => {
    const uow = createInMemoryUow();
    agencyRepository = uow.agencyRepository;
    listAgenciesByFilter = new ListAgenciesByFilter(
  ...
  it("returns empty list when the repository is empty", async () => {
    ...
    const agencies = await listAgenciesByFilter.execute({
      departmentCode: "75",
    });
  ...
  it("filters on departmentCode", async () => {
    ...
    const agenciesOf75 = await listAgenciesByFilter.execute({
      departmentCode: "75",
    });
  ...
  it("returns all agencies that match name", async () => {
    const agencies = [
      AgencyDtoBuilder.empty()
        .withId("11111111-1111-1111-1111-1111111name1")
        .withName("Agence Pôle emploi VITRY‐SUR‐SEINE")
        .build(),
      AgencyDtoBuilder.empty()
        .withId("11111111-1111-1111-1111-1111111name2")
        .withName("Agence Pôle emploi VITRY-LE-FRANCOIS")
        .build(),
      AgencyDtoBuilder.empty()
        .withId("11111111-1111-1111-1111-1111111name3")
    ...
    const agenciesWithVitry: AgencyIdAndName[] =
      await listAgenciesByFilter.execute({
        name: "vitry",
      });
    expect(agenciesWithVitry).toHaveLength(2);
    expectTypeToMatchAndEqual<AgencyIdAndName[]>(agenciesWithVitry, [
      {
        id: "11111111-1111-1111-1111-1111111name1",
        name: "Agence Pôle emploi VITRY‐SUR‐SEINE",
      },
      {
        id: "11111111-1111-1111-1111-1111111name2",
        name: "Agence Pôle emploi VITRY-LE-FRANCOIS",
      },
    ]);
  });
});
