...
export const VerificationPage = ({ route }: VerificationPageProps) => {
  ...
  return (
    <JwtImmersionApplicationProvider jwt={jwt}>
      <VerificationPageContent jwt={jwt} />
    </JwtImmersionApplicationProvider>
  );
};
...
const VerificationPageContent = ({ jwt }: VerificationPageContent) => {
  ...
  const immersionApplication = useContext(JwtImmersionApplicationContext);
